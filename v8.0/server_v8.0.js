 ...
 * Mojahedul Islam
 * Desc:: This version inctroduces log reporting.
*/
...
var logFileReporter = fs.createWriteStream(__dirname + '/debug.log', {flags : 'w'});
var logFile_stdout = process.stdout;
...
fs.appendFile('report.log', (date.getDay() + "-"+date.getMonth() + "-" +date.getFullYear() + "\n") );